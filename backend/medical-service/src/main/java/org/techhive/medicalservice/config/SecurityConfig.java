    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Medical folder analytics restricted to Doctors
                .requestMatchers("/api/medical-folders/analytics/**").hasAnyRole("DOCTOR", "ADMIN")
                .requestMatchers("/api/analytics/safety-audit/**").hasRole("DOCTOR")
