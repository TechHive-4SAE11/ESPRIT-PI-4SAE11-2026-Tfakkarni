...
public class MiniGame {
    ...
    @OneToMany(mappedBy = "miniGame", cascade = CascadeType.ALL, orphanRemoval = true, fetch = FetchType.LAZY)
    ...
    public MiniGame(String patientKeycloakId, String title, String description) {
